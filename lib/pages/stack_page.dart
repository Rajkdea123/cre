import 'package:credassignment/pages/second_stack_page.dart';
import 'package:credassignment/pages/third_stack_page.dart';
...
class StackPage extends StatefulWidget {
  ...
  const StackPage({super.key, required this.stackData});

  @override
  State<StackPage> createState() => _CreditPageState();
}

class _CreditPageState extends State<StackPage> with TickerProviderStateMixin {
                          ...
                          child: IconButton(
                              ...
                              onPressed: () {
                                if (Navigator.of(context).canPop()) {
                                  ...
                                  print(
                                      "You're already on the root page, nothing to pop.");
                                }
                              }),
                        ),
                      ),
